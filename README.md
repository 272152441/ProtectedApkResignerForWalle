...
- 在原有的基础上加入了修改 运行命令 `python ApkResigner.py 加固后的原文件路径  生成的路径`,即可自动生成所有渠道包。
...
[ProtectedApkResignerForWalle 一步解决应用加固导致Walle渠道信息失效的自动化脚本，自动生成渠道包](https://github.com/Jay-Goo/ProtectedApkResignerForWalle)
